...
// Get ACF fields
$download_images = get_field('downloadable_images');
        ...
        <div class="swiper image-slider">
            <div class="swiper-wrapper">
                <?php foreach ($slides as $slide): ?>
                    ...
                    $info      = $image_id ? get_offloaded_file_info($image_id) : ['ext' => 'N/A', 'size' => 'N/A'];
                    ?>
                    <div class="swiper-slide">
                        <div class="media-wrapper">
                            ...
                            <?php if ($download_images): ?>
                                <a class="download-btn" href="<?php echo esc_url($image_url); ?>" target="_blank" download>
                                    <div class="icon"></div>
                                    <div class="text">
                                        Download Image <span><?php echo esc_html($info['ext']); ?> - <?php echo esc_html($info['size']); ?></span>
                                    </div>
                                </a>
                            <?php endif; ?>
                        </div>
