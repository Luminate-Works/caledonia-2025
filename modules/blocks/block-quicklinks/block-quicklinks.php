            ...
            ?>
                <li class="link-group__item">
                    <a href="<?= esc_url($link_url) ?>" target="<?= esc_attr($link_target) ?>">
                        <span class="btn">
                            <?php if ($arrow): ?>
                                <svg class="arrow-right" width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="16" cy="16.9355" r="15.2" stroke="#FF8A45" stroke-width="1.6" />
                                    <path d="M11.0957 16.6191H20.429" stroke="#FF8A45" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M15.7617 11.9521L20.4284 16.6188L15.7617 21.2855" stroke="#FF8A45" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            <?php else: ?>
