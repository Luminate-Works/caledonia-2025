...
$cleanedClassName = trim(str_replace('news-slider', '', $className));


// Query latest post from chosen post type
$args = array(
    'post_type'      => 'post',
    'posts_per_page' => 3,
    'post_status'    => 'publish',
...
<div id="<?= esc_attr($id); ?>" class="<?= esc_attr($className); ?>">
    ...
    ?>
        ...
        <div class="listing-wrapper swiper">
            ...
            <div class="swiper-wrapper">
                ...
                ?>
                    ...
                    <a class="excerpt swiper-slide" href="<?php the_permalink(); ?>" title="<?= esc_attr(get_the_title()); ?>" aria-label="Read more about <?= esc_attr(get_the_title()); ?>">
