...
<div
            ...
            <div class="inner">
                ...
                <?php if ($show_search): ?>
                    <div class="search-bar">
                        <input type="text" x-model="searchQuery" placeholder="Search news" autocomplete="off" />
                    </div>
                <?php endif; ?>
    ...
    <div class="posts-listing" :class="{ 'limited': limitNumber }">
        <template x-for="item in postsWithSeparators()" :key="item.id">
            <div
