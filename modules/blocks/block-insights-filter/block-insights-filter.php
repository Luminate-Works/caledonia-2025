...
// ===============================================
// Block Template: Insights Filter by Category + post_sector
// with ACF toggles
// ===============================================
...
if (is_admin()) {
    echo '<p><strong>Insights Filter Block</strong></p>';
    return;
}
?>
...
<div
    ...
    <?php if ($show_filter): ?>
        <div class="insights-filter-controls">
            ...
            <div class="inner">
                <span class="insights-filter-label">
                    Filter by
                </span>
                ...
                <?php if ($show_search): ?>
                    <div class="search-bar">
                        <input type="text" x-model="searchQuery" placeholder="Search insights" autocomplete="off" />
                    </div>
                <?php endif; ?>
    ...
    <div class="insights-listing" :class="{ 'limited': limitNumber }">
        <template x-for="item in insightsWithSeparators()" :key="item.id">
            <div
...
<script>
    function insightsApp(data = {}) {
        return {
            ...
            loadInsights(reset = false, customLimit = null) {
                if (this.loading) return;
                this.loading = true;
                const fd = new FormData();
                fd.append('action', 'load_wp_insights');
